                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">edit opening</a>
                            </li>
                        </ul>
                    </div>
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> Edit Opening
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" data-placeholder="change status" tabindex="1">
                                                            <option value="Category 1">Open</option>
                                                            <option value="Category 2">On-hold</option>
                                                            <option value="Category 3">Closed</option>
                                                            <option value="Category 4">Withdrawed</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
